        ...
        t.prototype.initMenu = function () {
            ...
            t.prototype.initSearch = function () {
                ...
                a(document).on("click", function (t) {
                    return 0 === a(t.target).closest("#search-dropdown").length && a("#search-dropdown").removeClass("d-block"),
                        !0
                }),
        ...
        t.prototype.initTooltipPlugin = function () {
            ...
            t.prototype.initFormValidation = function () {
                e(".needs-validation").on("submit", function (t) {
                    return e(this).addClass("was-validated"),
                        !1 !== e(this)[0].checkValidity() || (t.preventDefault(),
                            t.stopPropagation(),
                            !1)
                })
            }
            ...
            t.prototype.initShowHidePassword = function () {
                e("[data-password]").on("click", function () {
                    "false" == e(this).attr("data-password") ? (e(this).siblings("input").attr("type", "text"),
                        e(this).attr("data-password", "true"),
                        e(this).addClass("show-password")) : (e(this).siblings("input").attr("type", "password"),
        ...
        t.prototype.activateDefaultSidebarTheme = function () {
            ...
            t.prototype.init = function () {
                e.LayoutThemeApp.init(),
                    ...
                    e.RightBar.init();
                var t = this.$body.data("layoutConfig");
                window.sessionStorage && t && t.hasOwnProperty("showRightSidebarOnStart") && t.showRightSidebarOnStart && (sessionStorage.getItem("_HYPER_VISITED_") || (e.RightBar.toggleRightSideBar(),
